...
public class Lab3_MyArrayMain {
    ...
    static private void arrayBasic_demo1() {
        MyArrayBasic660261 demo = new MyArrayBasic660261(7,6,8,1,2,3);
        System.out.println(demo);
    }
    static private void arrayBasic_demo2() {
        MyArrayBasic660261 demo = new MyArrayBasic660261();
        demo.insert(9, 0);
        demo.insert(7,0);
        demo.insert(5,0);
        System.out.println(demo);
    ...
    static private void myArray_demo4() {
        MyArray660261 demo = new MyArray660261(5);
        System.out.println(demo);
    ...
    static private void task2() {
        ...
        for (int N = initial; N <= 10 * initial; N += step) {
            ...
            MyArray660261 mArray = new MyArray660261(N);
            for (int n = 1; n <N; n++)
        ...
        for (int N = initial; N <= 10 * initial; N += step) {
            long start = System.currentTimeMillis();
            MyArray660261 mArray = new MyArray660261();
            for (int n = 1; n <N; n++)
                mArray.add((int)(Math.random()*1000));
            long time = (System.currentTimeMillis() - start);
            System.out.println(N + "\t\t" + time);
